...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dlsg/raw/circuits.csv", header true)
...
# MAGIC url STRING)
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dlsg/raw/races.csv", header true)
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dlsg/raw/constructors.json")
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS (path "/mnt/formula1dlsg/raw/drivers.json")
...
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dlsg/raw/results.json")
...
# MAGIC time STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dlsg/raw/pit_stops.json", multiLine true)
...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dlsg/raw/lap_times")
...
# MAGIC raceId INT)
# MAGIC USING json
# MAGIC OPTIONS (path "/mnt/formula1dlsg/raw/qualifying", multiLine true)
